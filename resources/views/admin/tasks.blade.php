...
@section('content')
                ...
                <form id="editTaskForm">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="edit_employee_id">Assign to<span class="text-danger">*</span></label>
                                <select name="edit_employee_id" id="edit_employee_id" class="form-select">
                                ...
                                <span class="text-danger" id="edit_employee_id_error"></span>
                            </div>
                            <div class="col-md-4">
    ...
    <div class="modal fade" id="viewTaskModal" tabindex="-1">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">View All Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="taskDetails">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.task_edit_btn', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#edit_employee_id').val(result.user_id);
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p>Registered Date: ${result.user.user_created_at}</p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p>Registered Date: ${result.project.project_created_at}</p>
                                </div>
                            </div>
                        </div>`;
            ...
            $('#editTaskForm').submit(function(e) {
                ...
                var action_url = "{{ route('update-task') }}";
